...
impl MidiUtil {
    ...
    pub fn note_midi_on_msg(note: &Note, channel: Channel, velocity: U7) -> Option<StructuredShortMessage> {
    ...
    pub fn note_midi_off_msg(note: &Note, channel: Channel, velocity: U7) -> Option<StructuredShortMessage> {
