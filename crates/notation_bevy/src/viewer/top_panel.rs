...
impl TopPanelState {
    pub fn sync_to_world(&self, config: &mut ResMut<BevyConfig>, query: &mut Query<&mut TabState>) {
...
pub fn top_panel_ui(
    ...
    egui::TopBottomPanel::top("top_panel").show(egui_ctx.ctx(), |ui| {
        ui.horizontal(|ui| {
            ...
            ui.add(Slider::new(&mut state.play_speed, 0.1..=2.0).text("Play Speed"));
